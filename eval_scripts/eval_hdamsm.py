...
def parse_args():
    ...
    parser.add_argument('--output_dir', dest='output_dir', type=str, default='') # ./output/pororo_hdamsm/Model/
    parser.add_argument('--data_dir', dest='data_dir', type=str, default='') # ./data/
    parser.add_argument('--manualSeed', type=int, help='manual seed')
    parser.add_argument('--debug', action='store_true')
    parser.add_argument('--ground_truth', action='store_true')
    parser.add_argument('--img_dir', type=str, default='') # out_dir <- inference result images_epoch_60
    parser.add_argument('--mode', type=str, required=True) # test
...
if __name__ == "__main__":
    ...
    #     (cfg.DATASET_NAME, cfg.CONFIG_NAME, 'Model')
    ...
    base_test = data.VideoFolderDataset(dir_path, counter, dir_path, 4, args.mode) # dir_path : ./data/ <- to retrieve caption data, args.mode : important <- retreival in keys
    testdataset = data.StoryDataset(base_test, dir_path, video_transform_val, return_caption=True, out_dir=out_dir) # out_dir : test / valid (generated result) 
    ...
    # args.output_dir <- load model (trained from train_damsm.py) ./output/pororo_hdamsm/Model/
